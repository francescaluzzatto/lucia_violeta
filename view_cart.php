...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<button type="submit" class="btn btn-success" name="save" style="background-color:#D8BFD8;border-color:#D8BFD8">Save Changes</button>
			<a href="clear_cart.php" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Clear Cart</a>
			<a href="checkout1.php" class="btn btn-success" style="background-color:#D8BFD8;border-color:#D8BFD8"><span class="glyphicon glyphicon-check" ></span> Checkout</a>
			</form>
		</div>
	</div>
</div>
